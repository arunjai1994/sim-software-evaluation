...
#### Build pseudo infusion (close enough)
```{r}
inf <- eventTable(amount.units = 'mg')
inf$add.dosing(dose = 1, nbr.doses = 1000, dosing.interval = 0.001)
...
This is not set up to do CI.  One way to approximate an infusion is by using [approachingly] infintesimal small boluses.  Thats what I did here - 1000 boluses of 1mg, spread out by 1hr/1000.  
Major practical problem - you must be sampling every time you adminster a bolus, so above sim had to generate 1.4 megs of data.
IMO lack of practical infusion ability is a game-ender.  Most drugs of PK relevance are administered IVPB or CI
